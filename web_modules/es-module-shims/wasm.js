...
/* ES Module Shims Wasm 1.9.0 */ (function() {
    ...
    /* es-module-lexer 1.5.0 */ var ImportType;
    !function(A) {
    ...
    function parse(E, g) {
        ...
        const o = [], K = [];
        for(; C.ri();){
            const A = C.is(), Q = C.ie(), B = C.it(), g = C.ai(), I = C.id(), w = C.ss(), D = C.se();
            let K;
            C.ip() && (K = k(E.slice(-1 === I ? A - 1 : A, -1 === I ? Q + 1 : Q))), o.push({
                n: K,
                t: B,
                s: A,
                e: Q,
        ...
        for(; C.re();){
            const A = C.es(), Q = C.ee(), B = C.els(), g = C.ele(), I = E.slice(A, Q), w = I[0], D = B < 0 ? void 0 : E.slice(B, g), o = D ? D[0] : "";
            K.push({
                s: A,
                e: Q,
                ls: B,
