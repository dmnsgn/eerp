...
if (!hasOwnProperty_1(IteratorPrototype$3, TO_STRING_TAG$4)) {
  createNonEnumerableProperty(IteratorPrototype$3, TO_STRING_TAG$4, 'Iterator');
}

if (FORCED || !hasOwnProperty_1(IteratorPrototype$3, 'constructor') || IteratorPrototype$3.constructor === Object) {
...
var iteratorCreateProxy = function (nextHandler, IS_ITERATOR) {
  ...
  IteratorProxy.prototype = redefineAll(objectCreate(IteratorPrototype$4), {
    next: function next(arg) {
...
_export({ target: 'Iterator', proto: true, real: true }, {
  reduce: function reduce(reducer /* , initialValue */) {
    ...
    if (noInitial) throw TypeError$g('Reduce of empty iterator with no initial value');
    return accumulator;
  }
});
...
_export({ target: 'Set', proto: true, real: true, forced: isPure }, {
  join: function join(separator) {
    ...
    var result = [];
    iterate(iterator, push$2, { that: result, IS_ITERATOR: true });
...
_export({ target: 'Set', proto: true, real: true, forced: isPure }, {
  reduce: function reduce(callbackfn /* , initialValue */) {
    ...
    if (noInitial) throw TypeError$j('Reduce of empty set with no initial value');
    return accumulator;
  }
});
...
export { callWithSafeIterationClosing as $, functionCall as A, setToStringTag as B, objectGetOwnPropertyDescriptor as C, objectCreate as D, anObject as E, toPropertyKey as F, createPropertyDescriptor as G, hiddenKeys as H, objectGetOwnPropertySymbols as I, isSymbol as J, isCallable as K, functionApply as L, objectPropertyIsEnumerable as M, copyConstructorProperties as N, createNonEnumerableProperty as O, objectSetPrototypeOf as P, objectGetPrototypeOf as Q, iterate as R, addToUnscopables as S, toIntegerOrInfinity as T, engineV8Version as U, toAbsoluteIndex as V, aCallable as W, getIteratorMethod as X, isArrayIteratorMethod as Y, getIterator as Z, _export as _, objectDefineProperty as a, arrayIncludes as a0, engineUserAgent as a1, toLength as a2, anInstance as a3, redefineAll as a4, functionName as a5, classof as a6, tryToString as a7, speciesConstructor as a8, requireObjectCoercible as a9, regexpExec as aA, es_array_iterator as aB, nativeWeakMap as aC, asyncIteratorPrototype as aD, asyncIteratorIteration as aE, asyncIteratorCreateProxy as aF, iteratorCreateProxy as aG, iteratorClose as aH, iteratorsCore as aI, collectionDeleteAll as aJ, mapEmplace as aK, collectionAddAll as aL, domIterables as aM, domTokenListPrototype as aN, getDefaultExportFromCjs as aO, commonjsGlobal as aP, toPrimitive as aa, ordinaryToPrimitive as ab, createCommonjsModule as ac, isForced_1 as ad, defineIterator as ae, objectDefineProperties as af, ownKeys as ag, correctPrototypeGetter as ah, toStringTagSupport as ai, documentCreateElement as aj, html as ak, inspectSource as al, aConstructor as am, aPossiblePrototype as an, regexpFlags as ao, regexpUnsupportedDotAll as ap, regexpUnsupportedNcg as aq, regexpStickyHelpers as ar, stringMultibyte as as, fixRegexpWellKnownSymbolLogic as at, getMethod as au, regexpExecAbstract as av, advanceStringIndex as aw, createIteratorConstructor as ax, isPure as ay, getSubstitution as az, isObject as b, classofRaw as c, toObject as d, indexedObject as e, functionUncurryThis as f, global_1 as g, hasOwnProperty_1 as h, isConstructor as i, functionBindContext as j, internalState as k, lengthOfArrayLike as l, getBuiltIn as m, shared as n, objectGetOwnPropertyNames as o, descriptors as p, fails as q, nativeSymbol as r, sharedKey as s, toIndexedObject as t, objectIsPrototypeOf as u, toString_1 as v, wellKnownSymbol as w, uid as x, redefine as y, objectKeys as z };
